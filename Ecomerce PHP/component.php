...
function component($productname, $productprice, $productimg, $productid){
    $element="
    <div class=\"col-md-3 col-sm-6 my-5 my-md-0 mx-md-2 \">
    <form action=\"product.php\"method=\"post\">
        <div class=\"card shadow mt-5\">
            <div>
                <img src=\"Image/$productimg\" alt=\"image1\" class=\"img-fluid card-img-top\">
            </div>
            <div class=\"card-body\">
                ...
                <p class=\"card-text\">
                    Some quick example text to be build on the card.
                </p>
                <h5>
